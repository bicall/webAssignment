...
$resultgetblog = mysqli_query($con, $getblog) or die(mysqli_error($con));
	...
	if(isset($_POST['submit'])){
		...
		header("location: ../../index.php?page=imggallery&&message=edit-success");
			}
			else{
				...
				<div class="col-md-12">
					...
					<form action="" method="POST" role="form" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" id="" name="title"  placeholder ="<?php echo $row['Title']; ?>" required>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<textarea type="text" class="form-control" id="" name="detail" placeholder="<?php echo $row['description']; ?>" required>  </textarea>
